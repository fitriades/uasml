...
if st.button('Visualisasi algoritma'):
    ...
    plot_tree(model, filled=True, feature_names=['age', 'sex', 'steroid', 'antivirals', 'fatigue', 'malaise', 'anorexia', 'liver_big', 'liver_firm', 'spleen_palpable', 'spiders', 'ascites', 'varices', 'bilirubin', 'alk_phosphate', 'sgot', 'albumin', 'protime', 'histology'], ax=ax, class_names=['Death', 'Survive'])
    st.pyplot(fig)